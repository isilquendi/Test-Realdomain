...
exports.TranslatePaginatorService = void 0;
...
var TranslatePaginatorService = /** @class */ (function (_super) {
    __extends(TranslatePaginatorService, _super);
    function TranslatePaginatorService(translate, titleService) {
    ...
    TranslatePaginatorService.prototype.getAndInitTranslations = function () {
        var _this = this;
        this.translate.get([
            ITEMS_PER_PAGE,
            NEXT_PAGE,
    ...
    TranslatePaginatorService = __decorate([
        core_1.Injectable({
            providedIn: 'root'
        })
    ], TranslatePaginatorService);
    return TranslatePaginatorService;
}(paginator_1.MatPaginatorIntl));
exports.TranslatePaginatorService = TranslatePaginatorService;
